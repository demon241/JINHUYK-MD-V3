...
console.log('LES FICHIERS PLUGINS SINSTALLENT AVEC SUCCÈS✅')
console.log('JINHUYK-MD-V3 CONNECTÉ À WHATSAPP PROFITEZ MERCI D'AVOIR CHOISI✅')

let up = `*┏───────────────────────❐*
> *➺ᴊɪɴʜᴜʏᴋ-ᴍᴅ-ᴠ3 ᴄᴏɴɴᴇᴄᴛé ᴀᴠᴇᴄ sᴜᴄᴄès, ᴛᴀᴘᴇᴢ .ᴍᴇɴᴜ à ʟᴀ ʟɪsᴛᴇ ᴅᴇ ᴄᴏᴍᴍᴀɴᴅᴇs ᴄʀééᴇs ᴘᴀʀ ᴋᴀɴɢ ᴊɪɴʜʏᴜᴋ✅*

> *❁ʀᴇᴊᴏɪɢɴᴇᴢ ɴᴏᴛʀᴇ ᴄʜᴀÎɴᴇ ᴡʜᴀᴛsᴀᴘᴘ ᴘᴏᴜʀ ʟᴇs ᴍɪsᴇs À ᴊᴏᴜʀ ᴊɪɴʜᴜʏᴋ-ᴍᴅ-ᴠ3❁*
