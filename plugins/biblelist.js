...
cmd({
    ...
    desc: "Obtenez la liste complète des livres de la Bible.",
    category: "fun",
    react: "📜",
    filename: __filename
...
`;
        ...
        const imageUrl = "https://i.postimg.cc/jjbSFpsm/JINHUYK-MD-V3.jpg'"; // Remplace "TON_LIEN_IMAGE_ICI" par ton lien d'image
        ...
        await conn.sendMessage(m.chat, {
            image: { url: imageUrl },
            caption: `📖 *Liste des bibles par JINHUYK-MD-V3*:\n\n` +
                     `Voici la liste complète des livres de la Bible:\n\n` +
